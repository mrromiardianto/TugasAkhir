...
public class Adapter_Usage extends RecyclerView.Adapter<Adapter_Usage.MyViewHolder> implements MyController {
    Context context;
    ...
    public Adapter_Usage (Context context, List<Item_Jadwal> data_menu) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_usage, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.Total.setText(menu.get(position).getTotal());
...
//        });
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        @BindView(R.id.list_app_name)
        TextView nama;
        @BindView(R.id.app_jumlahusage)
        TextView Total;
